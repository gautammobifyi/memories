...
const Form = ({currentId, setCurrentId}) => {
    ...
    return (
        <Paper className={classes.paper} >
            <from autoComplete="off" noValidate className={`${classes.root} ${classes.form}`}>
                ...
                <Button className={classes.buttonSubmit} variant="contained" color="primary"  onClick={handleSubmit} size="large" type="submit" fullWidth>Submit</Button>
